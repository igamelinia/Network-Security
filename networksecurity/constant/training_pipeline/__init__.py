...
""" Define constant that related with Data Validation"""
...
## imputer use Knn imputer : each missing value will replace with mean of nearest neighbor
# Setting params that will use in knn imputer
...
# we will save dataset after transformation with numpy format
DATA_TRANSFORMATION_TRAIN_FILE_NAME : str = "train.npy"
DATA_TRANSFORMATION_TEST_FILE_NAME : str = "test.npy"

""" Constant that has Model Trainer related """
