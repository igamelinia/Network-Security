...
# Create class for data ingestion process
class DataIngestion:
    ...
    def split_data_as_train_test(self, dataframe: pd.DataFrame):
        try:
            train_data, test_data = train_test_split(dataframe, test_size=self.data_ingestion_config.train_test_split)
            logging.info("Performed train test split on the dataframe")
            logging.info("Out from split_data_as_train_test method")
            ...
            logging.info("Export train and test file path succeses")
